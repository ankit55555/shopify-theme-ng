...
!(function (t) {
  ...
  (T4SThemeSP.BgVideo = function () {
    ...
    (T4SThemeSP.fixHand = function () {
      // Disable FastClick/hand.min.js on iOS to avoid input click issues.
      // Modern iOS Safari no longer needs FastClick's 300ms delay workaround.
      // Previously this function dynamically loaded 'hand.min.js' and attached FastClick
      // to document.body, which interfered with focusing inputs.
    });
})(jQuery_T4NT),
